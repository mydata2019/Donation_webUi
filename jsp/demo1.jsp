...
<link rel="stylesheet" href="../css/common.css">
 ...
 <script type="text/javascript">
    $(document).ready(function(){
    	...
    	if(path == 'ty1'){
    		$('.inputArea').find('.count').show();
            $('#phone').attr('value','01012345678');
            $('#phone').siblings('.btnS').text('인증번호 재발송');
            $('#confirm').attr('value','123456');
            $('.uiChk input[type=checkbox]').prop('checked',true);
            $('.btnArea button').attr('disabled',false);
    	}else{
            $('.inputArea').find('.count').hide();
        }
    });
...
<div id="wrap">
    ...
    <!--
    <form id="frm" method = "POST" action = "http://localhost:8080/get_svc_info">
    	<input id="SVC_NUM" type="text" name = "SVC_NUM" value = "01059272435">
    	<input id="tmp" type="submit" value="확인">
    </form>
    -->
    <!--<form id="frm" method = "POST" action = "http://localhost:8080/get_svc_info">-->
    <!--<form id="frm" method = "POST" action = "http://localhost:8000/customer/get_svc_info">-->
    <form id="frm" method = "POST" action = "http://a819dbefea6d111e9a5260241e1ca044-2045704601.ap-northeast-2.elb.amazonaws.com:8000/customer/get_svc_info">
        <div class="contBox mgt15">
            <div class="inputArea">
                <p class="phone">
                    <label for="phone">휴대폰번호</label>
                    <input type="tel" id="SVC_NUM" name = "SVC_NUM" placeholder="휴대폰 번호를 -없이 입력하세요." value = "01059272435">
                    <button type="button" class="btnS">인증번호 발송</button>

                </p>
                <p>
                    <label for="confirm">인증번호</label>
                    <span class="confirm">
                        <input type="tel" id="confirm" placeholder="인증번호를 입력하세요.">
                        <span class="count">02:59</span>
                    </span>
                </p>
            </div>
            ...
            <div class="agreeArea">
                ...
                <ul class="agreeList">
                    <li class="uiChk"><input type="checkbox" id="agree01" name="agree"><label for="agree01">이용약관 및 개인정보 취급방침 동의 (필수)</label> <a href="javascript:;" class="btnTermsView" onclick="layerOpne('term1')">[보기]</a></li>
                    <li class="uiChk"><input type="checkbox" id="agree02" name="agree"><label for="agree02">개인정보 수집, 이용동의 (필수)</label> <a href="javascript:;" class="btnTermsView" onclick="layerOpne('term2')">[보기]</a></li>
                </ul>
            </div>
        </div>

        <div class="btnArea">
            <!--  <button id="get_svc_info" type="button" class="btnL" disabled>서비스 조회하기</button>--> <!-- 활성화시 'disabled'속성 삭제 -->
            <input id="get_svc_info" type = "submit" value ="서비스 조회하기" class="btnL">
        </div>
      </form>
...
<div class="layerPopfull terms" id="term1" style="display:none;">
    <p class="popHead">이용약관 및 개인정보 취급방침 동의</p>
    <div class="popCont">
        <div class="termsCont">
...
<!-- 약관 보기 -->
<div class="layerPopfull terms" id="term2" style="display:none;">
    <p class="popHead">개인정보 수집, 이용동의</p>
    <div class="popCont">
        <div class="termsCont">
            <strong class="titDep3">제 1장 총칙</strong>
            <p>

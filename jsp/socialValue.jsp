  ...
  <div class="w3-main" style="margin-left:300px;margin-top:0px;">
    ...
    <div class="w3-container w3-padding-16" style="overflow:auto; overflow-x:hidden; scroll-behavior: smooth;">
      ...
      <header class="fixed" style="margin-top:-30px; ">
          <h1 style="margin: 0 0 0 0px; font-size: 15px;">맞춤형 상품 추천</h1>
          <h1 style="margin-top: -40px; font-size: 10px;" align="right"><더보기>　</h1>
      </header>
      <!-- container -->
    ...
    <div class="w3-container w3-padding-16" style="overflow:auto; overflow-x:hidden; scroll-behavior: smooth;">
      <!-- header -->
      <header class="fixed" style="margin-top:-30px; ">
          <h1 style="margin: 0 0 0 0px; font-size: 15px;">맞춤형 활동 추천</h1>
          <h1 style="margin-top: -40px; font-size: 10px;" align="right"><더보기>　</h1>
      </header>
      <!-- container -->
      <div id="container" style="padding-top:45px; margin-top: 0px">
    ...
    <div class="w3-container w3-padding-16" style="overflow:auto; overflow-x:hidden; scroll-behavior: smooth;">
      <!-- header -->
      <header class="fixed" style="margin-top:-30px; ">
          <h1 style="margin: 0 0 0 0px; font-size: 15px;">맞춤형 후원 추천</h1>
          <h1 style="margin-top: -40px; font-size: 10px;" align="right"><더보기>　</h1>
      </header>
      <!-- container -->
      <div id="container" style="padding-top:45px; margin-top: 0px">
